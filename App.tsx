...
function ExpoTabsContainer({
  ...
  return (
    <View
      style={[styles.demoTabsContainer, style]}
  ...
  return (
    ...
    >
      <Text
        style={[
          styles.demoTabText,
          isPrincipal && styles.demoTabTextActive,
          textStyle,
        ]}
      >
        {name}
  ...
  return (
    <ScrollView style={styles.page} contentContainerStyle={styles.pageContent}>
      ...
      <View style={styles.section}>
        ...
        <Text style={styles.sectionDescription}>
          Dense 14-card stack for overlap and clipping verification.
        </Text>
        <OverlappingCardsScrollRN
      ...
      {Platform.OS === "ios" && (
        <View style={styles.section}>
          ...
          <Text style={styles.sectionDescription}>
            Testing new `cardWidth` prop values.
          </Text>
          {IOS_WIDTH_EXAMPLES.map((example) => (
            <View
              key={`width-example-${example.label}`}
              style={styles.widthExample}
            >
              <Text style={styles.widthExampleLabel}>
                cardWidth={example.label}
              </Text>
              <OverlappingCardsScrollRN
                cardHeight={360}
